...
export default function TvlarLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#003352] text-white font-sans">
      ...
      {/* RODAPÉ */}
      <footer className="bg-[#002238] py-8 text-center text-xs text-slate-400">
        <p>Débora Lynn — Consultora independente Tvlar</p>
